...
public class ZendeskService {
	...
	public String altaTicketZendesk(UsuarioAlta usuarioAlta, String userAgent) {
		...
		// try(Zendesk zendesk = new
		// Zendesk.Builder(URL_ZENDESK).setUsername(ZENDESK_USER).setToken(TOKEN_ZENDESK).build())
		try {
			Builder builder = new Builder(URL_ZENDESK);
			Zendesk zendesk = builder.setUsername(ZENDESK_USER).setToken(TOKEN_ZENDESK).build();
